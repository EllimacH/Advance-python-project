...
class BateAdmin:
    ...
    def options_frame(self):
        ...
        self.frame1_welcome1 = ctk.CTkLabel(
            self.frame1,
            text="-Welcome Admin-",
        ...
        self.frame1_welcome2 = ctk.CTkLabel(
            self.frame1,
        ...
        self.change_to_users_info = ctk.CTkButton(
            self.frame1,
            ...
            width=280,
            height=40,
            command=self.select_users_info,
        )
        self.change_to_users_info.pack(padx=10, pady=50)
        self.change_to_change_info = ctk.CTkButton(
            self.frame1,
            text="Change Users Info",
            font=("Bodoni", 13, "bold"),
            width=280,
            height=40,
            command=self.select_change_info,
        )
        self.change_to_change_info.pack(padx=10, pady=50)
        self.change_to_change_plan = ctk.CTkButton(
            self.frame1,
            text="Add/Remove Products",
            font=("Bodoni", 13, "bold"),
            width=280,
            height=40,
            command=self.select_change_products,
        )
        self.change_to_change_plan.pack(padx=10, pady=50)

        # Creating a "Return" button
        self.return_button = ctk.CTkButton(
            self.frame1, text="Return", width=80, command=self.screen.quit
        )
    ...
    def create_check_users_info_frame(self):
        self.info_frame = ctk.CTkFrame(
            self.main_frame, width=795, fg_color="light blue"
        )
        self.info_frame.pack(side=LEFT, fill="y")
        self.info_frame.pack_propagate(FALSE)
        self.info_frame_title = ctk.CTkLabel(
            self.info_frame,
            text="---Users' Information---",
            font=("Bodoni", 20, "bold"),
            text_color="black",
        ).pack(pady=10)
        self.search_user_label = ctk.CTkLabel(
            self.info_frame,
            text="Search User:",
            font=("Bodoni", 15, "bold"),
            text_color="black",
        ...
        self.search_user = ctk.CTkEntry(
            self.info_frame, width=300, font=("Bodoni", 15, "bold"), text_color="white"
        ).place(x=380, y=50)

    def create_change_users_info_frame(self):
        self.change_info_frame = ctk.CTkFrame(
            self.main_frame, width=795, fg_color="light blue"
        )
        self.change_info_frame.pack(side=LEFT, fill="y")
        self.change_info_frame.pack_propagate(FALSE)
        self.change_info_frame_title = ctk.CTkLabel(
            self.change_info_frame,
            text="---Change Users' Information---",
            font=("Bodoni", 20, "bold"),
            text_color="black",
        ).pack(pady=10)
        self.search_user_label = ctk.CTkLabel(
