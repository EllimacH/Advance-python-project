...
class BateInfo:
    ...
    def info_frame(self):
        ...
        self.current_plans.pack(pady=6)
        ...
        self.current_VPN_package.pack(pady=6)
        ...
        self.current_VPS_package.pack(pady=6)
        ...
        self.current_domain.pack(pady=6)
